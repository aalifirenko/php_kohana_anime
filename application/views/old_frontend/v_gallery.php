...
<head>
    ...
    <title>AnimeNice :: Аниме Обои</title>
    <link rel="stylesheet" href="<?php echo URL::base(true); ?>media/css/gallery.css" type="text/css" />
    <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4/jquery.min.js"></script>
    <script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js"></script>
    <script type="text/javascript" src="<?php echo URL::base(true); ?>media/js/jquery.easing.1.3.js"></script>
    <script type="text/javascript" src="<?php echo URL::base(true); ?>media/js/jquery.mousewheel.min.js"></script>
</head>
<body>
<?php if (isset($pictures)): ?>
    <?php $firstPictire = false; ?>
    <?php $firstPictireSeo = false; ?>
    ...
    <div id="customScrollBox">
        <div class="container">
            <div class="content">
                ...
                <p>Аниме Обои от AniNice :)</p>
                <p>Чтобы сохранить изображение, кликните правой кнопкой мыши на изображении, и нажмите "Сохранить"</p>
                </div><div class="clear"></div>

                <?php foreach ($pictures as $picture): ?>
                    <?php
                        if ($firstPictire == false)
                        {
                            $firstPictire = $picture->img;
                            $firstPictireSeo = $picture->seo;
                        }
                    ?>
                    <a href="<?php echo $picture->img; ?>" class="thumb_link"><span class="selected"></span><img width="145" alt="<?php echo $picture->seo; ?>" title="Аниме Обои" src="<?php echo $picture->img; ?>" class="thumb" /></a>
                <?php endforeach; ?>
                <p class="clear"></p>
                <p class="footer">Все права защищены <a href="http://www.aninice.ru">aninice.ru</a> </p>
            </div>
        </div>
    </div>
</div>
<div id="bg">
    <img src="<?php echo $firstPictire; ?>" title="<?php echo $firstPictireSeo; ?>" id="bgimg" />
    <div id="preloader"><img src="<?php echo URL::base(true) ?>media/image/gallery/ajax-loader_dark.gif" width="32" height="32" align="absmiddle" />Загрузка...</div>
    <div id="arrow_indicator" title="Open images thumbnails"><img src="<?php echo URL::base(true) ?>media/image/gallery/sw_arrow_indicator.png" width="50" height="50" alt="Open images thumbnails" /></div>
    <div id="nextimage_tip">Кликните для следующего изображеия</div>
</div>
...
var images=["<?php echo URL::base(true) ?>media/image/gallery/ajax-loader_dark.gif","<?php echo URL::base(true) ?>media/image/gallery/round_custom_scrollbar_bg_over.png"];
